 ...
 *  IceInternal.Functional_TwowayCallbackArg1
...
implements GeneralParseRequestServicePrx {
    ...
    public AsyncResult begin_generalDealBidRequest(GeneralParaModel gpm, int isPC, Callback __cb) {
        return this.begin_generalDealBidRequest(gpm, isPC, null, false, false, (CallbackBase)__cb);
    }

    @Override
    public AsyncResult begin_generalDealBidRequest(GeneralParaModel gpm, int isPC, Map<String, String> __ctx, Callback __cb) {
        return this.begin_generalDealBidRequest(gpm, isPC, __ctx, true, false, (CallbackBase)__cb);
    }
    ...
    private AsyncResult begin_generalDealBidRequest(GeneralParaModel gpm, int isPC, Map<String, String> __ctx, boolean __explicitCtx, boolean __synchronous, Functional_GenericCallback1<GeneralResponseModel> __responseCb, Functional_GenericCallback1<Exception> __exceptionCb, Functional_BoolCallback __sentCb) {
        return this.begin_generalDealBidRequest(gpm, isPC, __ctx, __explicitCtx, __synchronous, (CallbackBase)new Functional_TwowayCallbackArg1<GeneralResponseModel>(__responseCb, __exceptionCb, __sentCb){
    ...
    public GeneralResponseModel end_generalDealBidRequest(AsyncResult __iresult) {
        OutgoingAsync __result = OutgoingAsync.check((AsyncResult)__iresult, (ObjectPrx)this, (String)"generalDealBidRequest");
        try {
            if (!__result.__wait()) {
                try {
                    ...
                    throw new UnknownUserException(__ex.ice_name(), (Throwable)__ex);
                }
            }
    ...
    public static GeneralParseRequestServicePrx checkedCast(ObjectPrx __obj) {
        return (GeneralParseRequestServicePrx)GeneralParseRequestServicePrxHelper.checkedCastImpl((ObjectPrx)__obj, (String)GeneralParseRequestServicePrxHelper.ice_staticId(), GeneralParseRequestServicePrx.class, GeneralParseRequestServicePrxHelper.class);
    }

    public static GeneralParseRequestServicePrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
        return (GeneralParseRequestServicePrx)GeneralParseRequestServicePrxHelper.checkedCastImpl((ObjectPrx)__obj, __ctx, (String)GeneralParseRequestServicePrxHelper.ice_staticId(), GeneralParseRequestServicePrx.class, GeneralParseRequestServicePrxHelper.class);
    }

    public static GeneralParseRequestServicePrx checkedCast(ObjectPrx __obj, String __facet) {
        return (GeneralParseRequestServicePrx)GeneralParseRequestServicePrxHelper.checkedCastImpl((ObjectPrx)__obj, (String)__facet, (String)GeneralParseRequestServicePrxHelper.ice_staticId(), GeneralParseRequestServicePrx.class, GeneralParseRequestServicePrxHelper.class);
    }

    public static GeneralParseRequestServicePrx checkedCast(ObjectPrx __obj, String __facet, Map<String, String> __ctx) {
        return (GeneralParseRequestServicePrx)GeneralParseRequestServicePrxHelper.checkedCastImpl((ObjectPrx)__obj, (String)__facet, __ctx, (String)GeneralParseRequestServicePrxHelper.ice_staticId(), GeneralParseRequestServicePrx.class, GeneralParseRequestServicePrxHelper.class);
    }

    public static GeneralParseRequestServicePrx uncheckedCast(ObjectPrx __obj) {
        return (GeneralParseRequestServicePrx)GeneralParseRequestServicePrxHelper.uncheckedCastImpl((ObjectPrx)__obj, GeneralParseRequestServicePrx.class, GeneralParseRequestServicePrxHelper.class);
    }

    public static GeneralParseRequestServicePrx uncheckedCast(ObjectPrx __obj, String __facet) {
        return (GeneralParseRequestServicePrx)GeneralParseRequestServicePrxHelper.uncheckedCastImpl((ObjectPrx)__obj, (String)__facet, GeneralParseRequestServicePrx.class, GeneralParseRequestServicePrxHelper.class);
    }
